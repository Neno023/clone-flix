    ...
    `
        <div class="row g-4">
            ...
            <div class="col-md-8">
                ...
                <p class="text-secondary small">
                    ⭐${show?.rating?.average ?? 'N/A'} . Lenguaje: ${show?.languaje ?? 'N/A'} . Status: ${show?.status ?? 'N/A'}
                </p>
                <a class"btn btn-outline-light me-2" href="${show?.officeSite || show?.url}" target="_blank" rel="noopener">
                    Web Site
                </a>
            </div>
        </div>
